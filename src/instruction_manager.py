...
class InstructionManager:
    ...
    def __init__(self, storage_dir: str = 'data/instructions'):
        ...
        self.instructions_file = os.path.join(storage_dir, 'instructions.json')
        self.personalities_file = os.path.join(storage_dir, 'personalities.json')
        self.behavior_rules_file = os.path.join(storage_dir, 'behavior_rules.json')
